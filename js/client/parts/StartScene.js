define([
  ...
  function StartScene(){
    ...
    this.addStartBtns=function(){
        this.addButton('./imgs/creategame.png','./imgs/creategameDown.png',null,{x:this.size.width/2,y:this.size.height*0.62})
        this.addButton('./imgs/joingame.png','./imgs/joingameDown.png',null,{x:this.size.width/2,y:this.size.height*0.80})
     }
